...
func init()->void :
	...
	if ProgressData.current_run_state.has_run_state:
		...
		set_neighbours(continue_button, more_games_button)
		set_neighbours(start_button, newsletter_button)
		set_neighbours(options_button, community_button)
		set_neighbours(progress_button, credits_button)
	else :
		start_button.grab_focus()
		start_button.focus_neighbour_top = quit_button.get_path()
		quit_button.focus_neighbour_bottom = start_button.get_path()
		
		set_neighbours(start_button, more_games_button)
		set_neighbours(options_button, newsletter_button)
		set_neighbours(progress_button, community_button)
		set_neighbours(quit_button, credits_button)
