...
onready var _name = $MarginContainer / VBoxContainer / HBoxContainer / VBoxContainer / Name as Label
onready var _description = $MarginContainer / VBoxContainer / HBoxContainer / VBoxContainer / Description
